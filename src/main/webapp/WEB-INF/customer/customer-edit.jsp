...
<script type="text/javascript" src="${pageContext.request.contextPath}/skin/js/theAlert.js"></script>
	<script>
		function updateCustomer(){
            $.ajax({
                url:"${pageContext.request.contextPath}/cus/updateCustomer",
                type:"post",
...
<form id="customerForm" name="form2">
...
<tr >
	...
	<td  align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<input size="60" name="comaddress" value="${customer.companyperson}"/>
	</td>
</tr>
<tr >
...
<tr >
	...
	<td align='left' bgcolor="#FFFFFF" onMouseMove="javascript:this.bgColor='#FCFDEE';" onMouseOut="javascript:this.bgColor='#FFFFFF';" height="22">
		<textarea name="present" rows=15 cols=130>${customer.present}</textarea>
	</td>
</tr>
...
<td height="28" colspan=4 align=center>
	&nbsp;
	<a href="javascript:updateCustomer();" class="coolbg">更新</a>
